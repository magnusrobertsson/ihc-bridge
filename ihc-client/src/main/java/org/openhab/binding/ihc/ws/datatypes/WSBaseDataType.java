...
import org.openhab.binding.ihc.ws.IhcException;
...
public abstract class WSBaseDataType {
	...
	public boolean parseValueToBoolean(String xml, String xpathExpression) throws IhcException {
		return Boolean.parseBoolean( parseValue( xml, xpathExpression) );
	}

	public abstract void encodeData(String data) throws IhcException;
